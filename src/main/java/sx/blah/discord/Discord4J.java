...
public class Discord4J {
     ...
     */
    public static String DESCRIPTION = "A Java binding for the unofficial Discord API, forked from https://github.com/nerd/Discord4J. Copyright (c) 2015, Licensed under GNU GPLv2";
    /**
