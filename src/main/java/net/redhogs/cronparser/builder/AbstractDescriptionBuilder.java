        ...
        if (StringUtils.isEmpty(expression) || "0".equals(expression)) {
            ...
            for (int i = 0; i < segments.length; i++) {
                ...
                if (segments[i].contains("-")) {
                    ...
                    descriptionContent.append(MessageFormat.format(getBetweenDescriptionFormat(segments[i]), getSingleItemDescription(subSegments[0]), getSingleItemDescription(subSegments[1])));
                } else {
